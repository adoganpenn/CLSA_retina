...
class RETFoundNotebookContractTests(unittest.TestCase):
    def test_full_run_flag_uses_all_visits_without_balancing(self) -> None:
        ...
        self.assertIn("sap_fundus_image_analysis", notebook)
        self.assertIn("age_at_fundus_years", notebook)
        self.assertIn("AGE_NMBR_COM", notebook)
        self.assertIn("AGE_NMBR_COF1", notebook)
